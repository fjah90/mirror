...
class Prospecto extends Model
{
    ...
    protected $fillable = ['cliente_id','nombre','descripcion', 'user_id','es_prospecto','vendedor_id','proyeccion_venta','fecha_cierre','factibilidad','estatus','total_proyeccion_venta'];
