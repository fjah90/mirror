      ...
      <div class="col-lg-12">
          ...
          <thead>
            <tr>
              ...
              <th class="text-center" style=" padding:3px 0 1px;">Proveedores</th>
              <th class="text-center" style=" padding:3px 0 1px;">IVA</th>
              <th class="text-center" style=" padding:3px 0 1px;">Monto</th>
              <th class="text-center" style=" padding:3px 0 1px;">Moneda</th>
              <th class="text-center" style=" padding:3px 0 1px;">Usuario</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">{{$entrada[10]}}</td>
            </tr>
            @endforeach
          </tbody>
        </table>
