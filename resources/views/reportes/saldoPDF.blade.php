...
<body>
  <div class="container">
    ...
    <div class="row margTop10">
      <div class="col-lg-12">
        <h4>REPORTE DE SALDO PROVEEDORES</h4>
      </div>
    </div>
      ...
      <div class="col-lg-12">
          ...
          <thead>
            <tr>
              ...
              <th class="text-center" style=" padding:3px 0 1px;">Fecha de Factura</th>
              <th class="text-center" style=" padding:3px 0 1px;">Fecha de Vencimiento</th>
              <th class="text-center" style=" padding:3px 0 1px;">Dias a favor o en contra</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">{{$entrada[9]}}</td>
            </tr>
            @endforeach
          </tbody>
        </table>
