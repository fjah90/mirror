      ...
      <div class="col-lg-12">
        <div class="panel ">
          <div class="panel-heading" style="background-color:#12160F; color:#B68911;">
            <h3 class="panel-title">Editar Tipo Proyecto</h3>
          </div>
            ...
            <form class="" @submit.prevent="guardar()">
              ...
              <div class="row" style="margin-top:25px;">
                <div class="col-md-12 text-right">
                  ...
                  <button type="submit" class="btn btn-success" :disabled="cargando" style="background-color:#12160F; color:#B68911;">
...
const app = new Vue({
    ...
    methods: {
      guardar(){
        this.cargando = true;
        axios.put('/subproyectos/{{$subproyecto->id}}', this.subproyecto)
        .then(({data}) => {
          this.cargando = false;
          swal({
