      ...
      <div class="panel">
        <div class="panel-heading" style="background-color:#12160F; color:#B68911;">
          <h3 class="panel-title text-right">
            ...
            <a href="{{route('categoriaClientes.create')}}" class="btn btn-warning" style="color: #000;">
                ...
                <tr v-for="(categoria, index) in categorias">
                  ...
                  <td class="text-right">
                    ...
                    <a class="btn btn-xs btn-success" data-toggle="tooltip" title="Editar"
                      :href="'/categoriaClientes/'+categoria.id+'/editar'" style="background: #fece58 !important;">
