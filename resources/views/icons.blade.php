...
@section('header_styles')
    <!-- page css -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/pages/icons.css')}}">
    <!-- end of page css -->
@stop
@section('content')
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="fa-icons">
                                ...
                                <section id="web-application">
                                    ...
                                    <div class="row fontawesome-icon-list">
                                        <div class="col-md-3 col-sm-4 icon_div">
                                        ...
                                        <div class="col-md-3 col-sm-4 icon_div">
                                            <i class="fa fa-fw fa-hand-o-left"></i> fa-bars
                                        </div>
                                        <div class="col-md-3 col-sm-4 icon_div">
                                        ...
                                        <div class="col-md-3 col-sm-4 icon_div">
                                            <i class="fa fa-fw fa-times removepanel clickable"></i> fa-times
                                        </div>
                                        <div class="col-md-3 col-sm-4 icon_div">
                            ...
                            <div class="tab-pane" id="glyphicons">
                                <h4 class="page-header">Glyphicons provided by Bootstrap</h4>
