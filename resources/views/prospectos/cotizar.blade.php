                                            ...
                                            <tr v-for="(cotizacion, index) in prospecto.cotizaciones">
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <!--
                                                           ...
                                                           title="Orden Compra"
                                                           :href="'/proyectos-aprobados/' + cotizacion.proyecto_aprobado.id +
                                                               '/ordenes-compra'"
                                                           target="_blank">
                        ...
                        <form class="" @submit.prevent="agregarEntrada()">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="text" name="ubicacion" v-model="cotizacion.ubicacion"/>
                                </div>
                                {{-- <div class="col-md-6">
                                            ...
                                            <tbody>
                                                <tr v-for="(descripcion, index) in entrada.descripciones">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div
                                                            v-else-if="descripcion.nombre=='Decoloración'">
