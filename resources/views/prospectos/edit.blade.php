            ...
            <form class="" @submit.prevent="actualizar()">
              ...
              <div class="row">
                <div class="col-sm-12 text-right">
                  @if($prospecto->es_prospecto =='si')
                    <a href='/prospectos/{{$disenador_id}}/anio/{{$anio}}/index' style="padding-top:8px; color:#000; background-color:#B3B3B3" class="btn btn-default">
                      Regresar
                    </a>
                  @elseif($prospecto->es_prospecto =='no')
                    <a href="{{url('/prospectos/cotizaciones/')}}" style="padding-top:8px; color:#000; background-color:#B3B3B3" class="btn btn-default">
                      Regresar
                    </a>
                  @endif
            ...
            <form class="" @submit.prevent="guardar2()">
              ...
              <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <label class="control-label">Descripción Actividad <strong style="color: grey"> *</strong></label>
                    <textarea name="descripcion" rows="5" cols="80" class="form-control" v-model="prospecto.nueva_proxima_actividad.descripcion" required></textarea>
                  </div>
                </div>
              <div class="row">
                <div class="col-md-12 text-right">
                 @if($prospecto->es_prospecto =='si')
                 <a href='/prospectos/{{$disenador_id}}/anio/{{$anio}}/index' style=" color:#000; background-color:#B3B3B3" class="btn btn-default">
                      Regresar
                    </a>
                  @elseif($prospecto->es_prospecto =='no')
                    <a href="{{url('/prospectos/cotizaciones/')}}" style="padding-top:8px; color:#000; background-color:#B3B3B3" class="btn btn-default">
