...
@section('content')
    ...
    <section class="content" id="content">
                        ...
                        <form class="" @submit.prevent="guardar()" id="formulario">
                            <div class="tab">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label class="control-label">Cliente <strong style="color: grey">
                                                    *</strong></label>
                                            <select class="form-control" name="cliente_id" v-model='prospecto.cliente_id'
                                                id="clienteSelect" required tabindex="-1">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="control-label">Nombre de Proyecto <strong style="color: grey">
                                                    *</strong></label>
                                            <input name="nombre" class="form-control" v-model="prospecto.nombre"
                                                required />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="control-label">Diseñador <strong style="color: grey">
                                                *</strong></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Proyección de venta <br>en USD <strong
                                                    style="color: grey"> *</strong></label>
                                            <input type="text" name="proyeccion_venta" class="form-control"
                            ...
                            <div class="tab">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="ultima_actividad.fecha" class="control-label">Fecha<strong
                                                    style="color: grey"> *</strong></label>
                                            <br />
                                            <dropdown>
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" name="fecha"
                                                        v-model="ultima_actividad.fecha" placeholder="DD/MM/YYYY"
                                                        readonly />
                                                </div>
                                                <template slot="dropdown">
                                                    <li>
                                                        <date-picker :locale="locale" :today-btn="false"
                                                            :clear-btn="false" format="dd/MM/yyyy"
                                                            :date-parser="dateParser" v-model="ultima_actividad.fecha" />
                                                    </li>
                                                </template>
                                            </dropdown>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Tipo <strong style="color: grey">
                                                    *</strong></label>
                                            <select class="form-control" name="tipo"
                                                v-model="ultima_actividad.tipo_id" required>
                                    ...
                                    <div class="col-sm-12">
                                        <ul style="list-style-type:none; padding:0;">
                                            <li style="margin-top:5px;"
                                                v-for="(ofrecido, index) in ultima_actividad.ofrecidos">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="descripcion" rows="5" cols="80" class="form-control"
                                            v-model="ultima_actividad.descripcion"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="proxima_actividad.fecha" class="control-label">Fecha <strong
                                                    style="color: grey"> *</strong></label>
                                            <br />
                                            <dropdown>
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" name="fecha"
                                                        v-model="proxima_actividad.fecha" placeholder="DD/MM/YYYY"
                                                        readonly />
                                                </div>
                                                <template slot="dropdown">
                                                    <li>
                                                        <date-picker :locale="locale" :today-btn="false"
                                                            :clear-btn="false" format="dd/MM/yyyy"
                                                            :date-parser="dateParser" v-model="proxima_actividad.fecha" />
                                                    </li>
                                                </template>
                                            </dropdown>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Tipo <strong style="color: grey">
                                                    *</strong></label>
                                            <select class="form-control" name="tipo"
                                                v-model="proxima_actividad.tipo_id" required>
                                                <option value="1">Llamada</option>
                                                <option value="12">Videollamada</option>
                                                <option value="2">Cita Presencial</option>
                                                <option value="13">Cita Showroom</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="control-label">Descripción Actividad</label>
                                        <textarea name="descripcion" rows="5" cols="80" class="form-control"
                                            v-model="proxima_actividad.descripcion"></textarea>
                                    </div>
                                </div>
                            ...
                            <div style="overflow:auto;">
                                <div style="float:right;">
                                    <button type="button" class="btn btn-white rounded" id="prevBtn"
                                        @click="siguienteTab(-1)">
                                        < Anterior</button>
                                            <button type="button" class="btn btn-white rounded" id="nextBtn"
        ...
        <modal v-model="modalCliente" title="Registrar Cliente" :footer="false">
            <iframe id="theFrame" src="../clientes/crearNacional?layout=iframe" style="width:100%; height:700px;"
                frameborder="0">
            </iframe>
        </modal>
        <!-- /.Nuevo Cliente Modal -->
        ...
        <modal v-model="modalProducto" title="Registrar Producto" :footer="false">
            <iframe id="theFrame" src="../productos/crear?layout=iframe" style="width:100%; height:700px;"
                frameborder="0">
            </iframe>
        </modal>
        <!-- /.Nuevo Producto Modal -->
    ...
    <script>
        ...
        const app = new Vue({
            ...
            mounted() {
                ...
                this.clienteSelect = $('#clienteSelect').select2({
                    width: '100%'
            ...
            methods: {
                ...
                guardar() {
                  actualizarHorarioProximaActividad(true) 
