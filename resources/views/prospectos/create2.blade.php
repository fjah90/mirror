              ...
              <div class="tab">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <button type="button" id="show-modal" @click="modalCliente = true" class="btn btn-effect-ripple form-control" style="background-color:black; color:#FBAE08;">Nuevo Cliente</button>
