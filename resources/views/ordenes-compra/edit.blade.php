                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label text-danger" style="font-weight:bold">Orden
                                            Rechazada</label>
                        ...
                        <div class="row form-group">
                            ...
                            @if ($orden->proveedor_id)
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" name="numero_cliente" v-model="orden.numero_cliente" />
                                </div>
                            @else
                                <div class="col-md-3">
                                    <label class="control-label">Proveedor /<br> To</label>
                                    <select class="form-control" name="proveedor_id" v-model='orden.proveedor_id' required
                                        @change="fijarProveedor()">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="tiempo.valor" v-model="orden.tiempo.valor"
                                    :disabled="orden.tiempo.id != '0'" />
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-4">
                                ...
                                <dropdown style="width:100%;">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="fecha_compra"
                                            v-model="orden.fecha_compra_formated" placeholder="DD/MM/YYYY" readonly />
                                    </div>
                                    <template slot="dropdown">
                                        <li>
                                            <date-picker :locale="locale" :today-btn="false"
                                                :clear-btn="false" format="dd/MM/yyyy" :date-parser="dateParser"
                                                v-model="orden.fecha_compra_formated" />
                                        </li>
                                    </template>
                                </dropdown>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="0.01" name="cantidad"
                                            class="form-control" v-model="entrada.cantidad" @change="convertir1()"
                                            required />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Unidad Medida
                                            {{ $orden->moneda == 'Dolares' ? '/ Unidad Medida Ingles' : '' }}</label>
                                        <select class="form-control" name="medida" v-model="entrada.medida" required
                                            ...
                                            @foreach ($unidades_medida as $unidad)
                                                @if ($orden->moneda == 'Dolares')
                                                    <option value="{{ $unidad->simbolo }}">{{ $unidad->simbolo }} /
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-bordred">
                                ...
                                <tbody>
                                    <tr v-for="(entrada, index) in proyecto.cotizacion.entradas"
                                        v-if="entrada.precio_compra!=null">
                                        <td>@{{ entrada.producto.nombre }}</td>
        ...
        const app = new Vue({
            ...
            methods: {
                ...
                convertir2() {
                    ...
                    if (this.entrada.conversion != "") {
                        this.entrada.cantidad =
                            (this.entrada.cantidad_convertida * this.conversiones[this.entrada.conversion][this
                                .entrada.medida
                            ])
                            .toFixed(2);
                    }
                ...
                agregarEntrada() {
                    ...
                    if (this.entrada.cantidad_convertida != "" && this.entrada.cantidad_convertida != null && this
                        .entrada.cantidad_convertida != undefined) {
                ...
                guardar() {
                    ...
                    */
                    ...
                    this.cargando = true;
                    axios.post(
                            '/proyectos-aprobados/{{ $proyecto->id }}/ordenes-compra/{{ $orden->id }}/actualizar',
                            formData, {
                                headers: {
