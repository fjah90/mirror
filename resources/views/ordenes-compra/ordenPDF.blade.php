        ...
        <table class="table table-cotizacion" style="margin:-5px 0px 0px;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center" style="border-bottom: none; border-top: none">@format_number($entrada->cantidad_convertida) <br /> {{$entrada->conversion}}</td>
              @else
              ...
              <td  style="border-bottom: none; border-top: none">
                <table style="width:100%; margin:0;">
                  <tr>
                    ...
                    <td style="width:100px;" style="border-bottom: none; border-top: none">
