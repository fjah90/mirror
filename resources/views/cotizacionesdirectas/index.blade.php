                ...
                <div class="panel">
                    <div class="panel-heading" style="background-color:#12160F; color:#B68911;">
                        <div class="p-10 text-right" >
                            <a class="btn btn-warning btn-sm btn" href="{{ route('cotizacionesdirectas.create') }}" style="color:#000;">
                           ...
                           <tbody>
                              <tr v-for="(cotizacion, index) in cotizaciones">
                                 ...
                                 <td class="text-right">
                                       ...
                                       <a class="btn btn-xs btn-warning" title="Editar" :href="'/cotizacionesdirectas/'+ cotizacion.id + '/edit'">
