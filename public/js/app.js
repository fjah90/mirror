...
/* WEBPACK VAR INJECTION */(function(__webpack_provided_window_dot_jQuery, $) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(140);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_uiv__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tinymce_tinymce_vue__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_phone_number_input__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_the_mask__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_the_mask___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_vue_the_mask__);
window.$ = __webpack_provided_window_dot_jQuery = __webpack_require__(0);
window.swal = __webpack_require__(32);
__webpack_require__(33);
__webpack_require__(84);
__webpack_require__(85);
window.JSZip = __webpack_require__(34);
var pdfMake = __webpack_require__(61);
var pdfFonts = __webpack_require__(62);
...
window.objectToFormData = __webpack_require__(68);
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.directive('mask', __WEBPACK_IMPORTED_MODULE_5_vue_the_mask__["mask"]);
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('select2multags', __webpack_require__(163));
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('contacto-emails', __webpack_require__(166));
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('contacto-telefonos', __webpack_require__(169));
...
Component.options.__file = "resources/assets/js/components/contacto-emails.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-64f67c4e", Component.options)
  } else {
    hotAPI.reload("data-v-64f67c4e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    agregar: function agregar() {
      ...
      if (this.email.id) this.actualizar();else this.guardar();
    },
    guardar: function guardar() {
      ...
      axios.post('/emails', { contacto_id: this.contacto_id, contacto_type: this.contacto_type,
        tipo: this.email.tipo, email: this.email.email }).then(function (_ref) {
        var data = _ref.data;

        _this.emails.push(data.email);
        _this.email = { tipo: "", email: "" };
    ...
    actualizar: function actualizar() {
      ...
      this.cargando = true;
      axios.put('/emails/' + this.email.id, this.email).then(function (_ref3) {
        var data = _ref3.data;

        _this2.emails.push(_this2.email);
        _this2.email = { tipo: "", email: "" };
    ...
    editar: function editar(email, index) {
      this.email = email;
      this.emails.splice(index, 1);
    },
    borrar: function borrar(email, index) {
      var _this3 = this;
      ...
      this.cargando = true;
      axios.delete('/emails/' + email.id, {}).then(function (_ref5) {
        var data = _ref5.data;
    ...
    [
        ...
        [
          _c("div", { staticClass: "row form-group" }, [
            ...
            _c("div", { staticClass: "col-md-4" }, [
              _c("label", { staticClass: "control-label" }, [_vm._v("Tipo")]),
              _vm._v(" "),
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.email.tipo,
                    expression: "email.tipo"
                  }
                ],
                staticClass: "form-control",
                attrs: { type: "text", name: "tipo" },
                domProps: { value: _vm.email.tipo },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.email, "tipo", $event.target.value)
                  }
                }
              })
            ]),
      ...
      _vm._l(_vm.emails, function(email, index) {
        return _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-md-4" }, [_vm._v(_vm._s(email.tipo))]),
          _vm._v(" "),
          _c("div", { staticClass: "col-md-6" }, [_vm._v(_vm._s(email.email))]),
          _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-64f67c4e", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/contacto-telefonos.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e6386c50", Component.options)
  } else {
    hotAPI.reload("data-v-e6386c50", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    agregar: function agregar() {
      ...
      if (this.telefono.id) this.actualizar();else this.guardar();
    },
    guardar: function guardar() {
      var _this = this;
      ...
      axios.post('/telefonos', { contacto_id: this.contacto_id, contacto_type: this.contacto_type,
        tipo: this.telefono.tipo, telefono: this.telefono.telefono, extencion: this.telefono.extencion }).then(function (_ref) {
        var data = _ref.data;

        _this.telefonos.push(data.telefono);
        _this.telefono = { tipo: "", telefono: "", extencion: "" };
        _this.cargando = false;
      }).catch(function (_ref2) {
        var response = _ref2.response;
    ...
    actualizar: function actualizar() {
      ...
      this.cargando = true;
      axios.put('/telefonos/' + this.telefono.id, this.telefono).then(function (_ref3) {
        var data = _ref3.data;

        _this2.telefonos.push(_this2.telefono);
        _this2.telefono = { tipo: "", telefono: "", extencion: "" };
        _this2.cargando = false;
      }).catch(function (_ref4) {
        var response = _ref4.response;
    ...
    editar: function editar(telefono, index) {
      this.telefono = telefono;
      this.telefonos.splice(index, 1);
    },
    borrar: function borrar(telefono, index) {
      var _this3 = this;
      ...
      this.cargando = true;
      axios.delete('/telefonos/' + telefono.id, {}).then(function (_ref5) {
        var data = _ref5.data;

        _this3.telefonos.splice(index, 1);
        _this3.cargando = false;
      }).catch(function (_ref6) {
        var response = _ref6.response;
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("div", { staticClass: "row form-group" }, [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "col-md-4" }, [
              _c("label", { staticClass: "control-label" }, [_vm._v("Numero")]),
              _vm._v(" "),
              _vm.nacional
                ? _c("input", {
                    directives: [
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.telefono.extencion,
                    expression: "telefono.extencion"
                  }
                ],
                staticClass: "form-control",
                attrs: { type: "text" },
                domProps: { value: _vm.telefono.extencion },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.telefono, "extencion", $event.target.value)
                  }
                }
              })
            ]),
      ...
      _vm._l(_vm.telefonos, function(telefono, index) {
        return _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-md-4" }, [
            _vm._v(_vm._s(telefono.tipo))
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "col-md-4" }, [
            _vm._v(_vm._s(telefono.telefono))
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "col-md-2" }, [
            _vm._v(_vm._s(telefono.extencion))
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "col-md-2 text-right" }, [
            _c(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e6386c50", module.exports)
  }
}
